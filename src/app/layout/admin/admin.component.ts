...
export class AdminComponent implements OnInit {
  ...
  @ViewChild(MenuProfileComponent) private menuProfile: MenuProfileComponent;
  @ViewChild(NotificationsComponent)
  private notificationCom: NotificationsComponent;
  @ViewChild(MessagesComponent) private messagesCom: MessagesComponent;
  toggleLiveNotification() {
    this.notificationCom.toggle();
  ...
  */
  ...
  toggleInnerChat() {
    this.messagesCom.toggleInnerChat();
...
export class LinkTriggerDirective {
  ...
  onToggle($event: any) {
    ...
    parentEle
      .querySelector(".pcoded-hasmenu")
      .classList.remove("pcoded-trigger");
